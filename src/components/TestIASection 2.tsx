...
const TestIASection = () => {
  ...
  // Couleurs d'ombre en fonction du thème
  const shadowColors = {
    pizzeria: '0, 81%, 44%',    // Rouge
    snack: '48, 96%, 41%',      // Jaune
    restaurant: '200, 100%, 14%' // Bleu
  };
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-4 md:gap-8">
            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              <motion.button
                onClick={handleCall}
                className={`
                  relative w-full px-8 py-6 md:py-8 rounded-2xl text-xl md:text-2xl font-black
                ...
                style={{
                  background: isActive
                    ...
                    : 'linear-gradient(135deg, #fdefd5 0%, #fce4b8 100%)',
                  color: isActive ? '#fdefd5' : '#000',
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = '16px 16px 0 #000';
                ...
                whileTap={{ scale: 0.95 }}
                aria-label={isActive ? "Appel en cours" : "Appeler Pasta O Plomo"}
              >
                ...
                {isActive ? (
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <Phone className="w-10 h-10 md:w-12 md:h-12" strokeWidth={3} />
                    <span className="text-base md:text-xl">Tester l'agent IA vocal</span>
                  </div>
                )}
              </motion.button>
