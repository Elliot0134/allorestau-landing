...
const Floating = ({
  ...
  useAnimationFrame(() => {
    ...
    elementsMap.current.forEach((data) => {
      // If disabled (e.g., during theme transitions), reset to center position
      if (disabled) {
        const resetSpeed = 0.2 // Fast reset during transitions
      ...
      // Calculate new target position (INVERSÉ - mouvement opposé au curseur)
